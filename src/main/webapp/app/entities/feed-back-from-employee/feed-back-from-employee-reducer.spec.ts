...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './feed-back-from-employee.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FEEDBACKFROMEMPLOYEE_LIST actions', async () => {
    ...
    it('dispatches FETCH_FEEDBACKFROMEMPLOYEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FEEDBACKFROMEMPLOYEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FEEDBACKFROMEMPLOYEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FEEDBACKFROMEMPLOYEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FEEDBACKFROMEMPLOYEE actions', async () => {
      const expectedActions = [
        {
