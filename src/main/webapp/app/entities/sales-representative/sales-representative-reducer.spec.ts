...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './sales-representative.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SALESREPRESENTATIVE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SALESREPRESENTATIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SALESREPRESENTATIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SALESREPRESENTATIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SALESREPRESENTATIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SALESREPRESENTATIVE actions', async () => {
      const expectedActions = [
        {
