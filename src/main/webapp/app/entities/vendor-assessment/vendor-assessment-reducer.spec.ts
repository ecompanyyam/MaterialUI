...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './vendor-assessment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VENDORASSESSMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_VENDORASSESSMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VENDORASSESSMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VENDORASSESSMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VENDORASSESSMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VENDORASSESSMENT actions', async () => {
      const expectedActions = [
        {
