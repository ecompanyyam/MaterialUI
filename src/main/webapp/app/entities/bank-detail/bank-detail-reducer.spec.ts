...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANKDETAIL_LIST actions', async () => {
    ...
    it('dispatches FETCH_BANKDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BANKDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BANKDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BANKDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BANKDETAIL actions', async () => {
      const expectedActions = [
        {
