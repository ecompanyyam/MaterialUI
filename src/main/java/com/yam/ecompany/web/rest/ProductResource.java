...
import com.yam.ecompany.service.ProductQueryService;
...
/**
 * REST controller for managing {@link com.yam.ecompany.domain.Product}.
 */
@RestController
@RequestMapping("/api")
public class ProductResource {
    ...
    private Product setMetadata(Product product) throws ImageProcessingException, IOException, MetadataException {
        String str = DatatypeConverter.printBase64Binary(product.getProductImage());
