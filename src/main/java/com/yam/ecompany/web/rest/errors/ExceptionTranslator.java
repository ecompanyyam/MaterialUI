package com.yam.ecompany.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.yam.ecompany.service.EmailAlreadyUsedException ||
            ex instanceof com.yam.ecompany.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof com.yam.ecompany.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.yam.ecompany");
    }
}
